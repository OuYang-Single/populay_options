...
@ActivityScope
public class StudyForexPresenter extends BasePresenter<StudyForexContract.Model, StudyForexContract.View> {
    ...
    @Inject
    public StudyForexPresenter(StudyForexContract.Model model, StudyForexContract.View rootView) {
