...
@ActivityScope
public class DemoTradingFragmentModel extends BaseModel implements DemoTradingFragmentContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    Retrofit mRetrofit;
    @Inject
    public DemoTradingFragmentModel(IRepositoryManager repositoryManager) {
