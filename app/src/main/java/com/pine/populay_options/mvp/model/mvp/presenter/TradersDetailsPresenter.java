...
@ActivityScope
public class TradersDetailsPresenter extends BasePresenter<TradersDetailsContract.Model, TradersDetailsContract.View> {
    @Inject
    ...
    @Inject
    public TradersDetailsPresenter(TradersDetailsContract.Model model, TradersDetailsContract.View rootView) {
